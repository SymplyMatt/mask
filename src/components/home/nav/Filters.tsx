        ...
        <div className="grid grid-cols-7 auto gap: 10px; justify-between items-center px-50 pt-20 w-full">
            <div className="col-span-5 flex items-center gap-24 w-full justify-start">
                <Swiper
                    ...
                    >
                        <SwiperSlide>
                          <div className={`flex flex-col justify-center items-center gap-5 ${isDarkMode ? 'text-white border-white' : 'text-black border-black'} py-10 border-b-2  justify-start hover:opacity-100 cursor-pointer transition-transform transform-gpu hover:shadow-lg hover:border-b-2 hover:border-gray-300`}>
                        ...
                        <SwiperSlide>
                            <div className={`flex flex-col justify-center items-center gap-5 ${isDarkMode ? 'text-white' : 'text-black'} py-10  justify-start hover:opacity-100 cursor-pointer transition-transform transform-gpu hover:shadow-lg hover:border-b-2 hover:border-gray-300 opacity-50`}>
            ...
            <div className="col-span-2 flex items-center w-full justify-end">
                <div className="flex justify-center items-center"><button type="button" className={`${isDarkMode ?  'text-white bg-darkModeColorOne hover:bg-darkModeColorOne border-darkModeColorTwo' : 'text-black bg-white hover:bg-white border-gray-300'} focus:outline-none font-medium rounded-lg px-10 py-12 me-2 mb-2 text-14 border flex justify-center items-center gap-5`}><FilterIcon /> Filters</button></div>
                <div className="flex justify-center items-center"><button type="button" className={`${isDarkMode ?  'text-white bg-darkModeColorOne hover:bg-darkModeColorOne border-darkModeColorTwo' : 'text-black bg-white hover:bg-white border-gray-300'} focus:outline-none font-medium rounded-lg px-10 py-12 me-2 mb-2 text-14 border flex justify-center items-center gap-5`}>Display total before taxes <i className={`fa-solid fa-toggle-off text-24 ${isDarkMode ? 'text-fadedWhite' :  'text-gray-600'} flex justify-center items-center`}></i></button></div>
            </div>
        </div>
    </>
  )
