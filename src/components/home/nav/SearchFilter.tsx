...
const SearchFilter = () => {
  return (
    <>
        <div className='grid grid-cols-3 w-[80%] justify-between items-center border border-gray-200 rounded-30 cursor-pointer mx-auto text-12 shadow-md transition duration-300 ease-in-out mx-50'>
